...
<div>
    ...
    <textarea id="{{ $name }}" rows="{{ $rows }}"
        {{ $attributes->class(['mt-1 w-full rounded-lg border-white/10 bg-slate-800 px-3 py-2 text-sm text-slate-100 focus:border-emerald-500 focus:ring-emerald-500']) }}></textarea>
    @if ($hint)
